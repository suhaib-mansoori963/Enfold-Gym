  ...
  return (
    <section>
      ...
      <div className="relative h-[800px] flex items-center justify-center text-center overflow-hidden">
        ...
        {/* Content */}
        <div className="relative z-10 flex gap-8 px-10 ">
          {/* First Card */}
          <div className="w-[26%] bg-white h-[600px] text-black text-[20px] mx-[20px]">
            ...
            <div className="!py-[18px]">
              <h3 className="!text-[50px] font-bold">19,60$</h3>
          ...
          <div className="w-[26%] bg-white h-[600px] text-black text-[20px] mx-[20px]">
            ...
            <div className="!py-[18px]">
              <h3 className="!text-[50px] font-bold">49,00$</h3>
              <p className="!text-[15px]">per month</p>
            </div>
            <div className="!text-[#a0a0a0] text-[16px] py-[15px]">
          ...
          {/* Third Section */}
          <div className="w-[26%] h-[600px] mx-[50px] text-white text-[20px] text-center items-center flex flex-col justify-center">
            <div className="!py-[48px]">
              <h3 className="text-[50px] font-bold">
                87 <span className="!text-[#a0a0a0] !text-[40px]">Studios</span>
              </h3>
              <p className="!text-[22px]">around the world</p>
            </div>
            <hr className="w-[12%] border-2 " />
            <div className=" py-[48px]">
              <p className="text-[50px] font-bold">298.000</p>
              <p>active members</p>
            </div>
            <hr className="w-[12%] border-2   " />
            <div className=" py-[48px]">
              <p className="!text-[50px] font-bold">
                19,90<span className="!text-[#a0a0a0] !text-[40px]">$</span>
              </p>
              <p>Starting Price</p>
            </div>
          </div>
      ...
      {/* <div className="w-full p-[20px] lg:p-[50px]">
        ...
        <div>
          ...
          <ul className="text-[#6e6e6e] p-[10px]">
            <li className=" p-[4px]">
      ...
      <div className="py-[50px]">
        <h1 className="text-[40px] lg:text-[70px] font-bold mx-[120px] ">
          FAQ<span className="text-[#d63e2d]">.</span>
        </h1>
